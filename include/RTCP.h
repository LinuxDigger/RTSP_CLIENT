...
#ifndef INCLUDE_RTCP_H_
#define INCLUDE_RTCP_H_
...
typedef void RTCPAppHandlerFunc(void* clientData, u_int8_t subtype,
		u_int32_t nameBytes/*big-endian order*/, u_int8_t* appDependentData,
...
public:
	// because this stuff is used by an external "C" function
