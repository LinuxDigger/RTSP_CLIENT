...
#ifndef INCLUDE_RTPSINK_H_
#define INCLUDE_RTPSINK_H_
...
public:
	...
	void noteIncomingRR(u_int32_t SSRC,
			...
			unsigned lastPacketNumReceived, unsigned jitter,
...
private:
	// constructor and destructor, called only by RTPSink:
