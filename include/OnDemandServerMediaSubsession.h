/*
 * OnDemandServerMediaSubsession.h
 *
 *  Created on: Aug 10, 2018
 *      Author: jhb
 */

#ifndef INCLUDE_ONDEMANDSERVERMEDIASUBSESSION_H_
#define INCLUDE_ONDEMANDSERVERMEDIASUBSESSION_H_
...
class Destinations {
public:
	Destinations(struct in_addr const& destAddr, Port const& rtpDestPort,
