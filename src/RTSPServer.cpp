...
//		fTCPStreamingDatabase(HashTable::create(ONE_WORD_HASH_KEYS)), fPendingRegisterOrDeregisterRequests(
//				HashTable::create(ONE_WORD_HASH_KEYS)), fRegisterOrDeregisterRequestCounter(
...
//	while ((r =
//			(RTSPRegisterOrDeregisterSender*) fPendingRegisterOrDeregisterRequests->getFirst())
//			!= NULL) {
//		delete r;
//	}
