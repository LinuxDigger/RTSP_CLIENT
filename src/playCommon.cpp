...
//		char* resultString, CommonPlay *cpObj);
//void continueAfterSETUP(RTSPClient* client, int resultCode, char* resultString, CommonPlay *cpObj);
//void continueAfterPLAY(RTSPClient* client, int resultCode, char* resultString, CommonPlay *cpObj);
...
//static void checkSessionTimeoutBrokenServer(void* clientData,CommonPlay *cpObj);
...
//unsigned fileSinkBufferSize = 1000000; //////////////////////////////////100000is origin
...
//}
//
//void setEnvURL(UsageEnvironment& envv, const char*URL) {
//	env = &envv;
//	streamURL = URL;
//}
//
...
//	cout << "getSessionName():::::" << session->getSessionName()
//			<< " env . cliID " << env->_cliID << endl;
...
//						<< env->getResultMsg() << "\n";
//			} else {
//				*env << "Created receiver for \"" << subsession->mediumName() // audio
...
//					unsigned curBufferSize = getReceiveBufferSize(*env,
//							socketNum);
...
//										fileSinkBufferSize;
//						newBufferSize = setReceiveBufferTo(*env, socketNum,
//								newBufferSize);
...
//						fileSinkBufferSize, 0, oneFilePerFrame);
//			}
...
//		cout << "cliID:::::::::::::::::::::::::::::::::::::" << env->_cliID
//				<< endl;
//
//		pthread_mutex_lock(DP_RTSP_CLIENT_Client::mCliMuxSet[env->_cliID]);
//		pthread_cond_signal(DP_RTSP_CLIENT_Client::mCliCondSet[env->_cliID]);
//		pthread_mutex_unlock(DP_RTSP_CLIENT_Client::mCliMuxSet[env->_cliID]);
//
//	}
//	delete[] resultString;
//
...
//		double rangeAdjustment = (session->playEndTime()
//				- session->playStartTime()) - (endTime - initialSeekTime);
...
//}
//
//void subsessionByeHandler(void* clientData, CommonPlay *cpObj) {
//	struct timeval timeNow;
//	gettimeofday(&timeNow, NULL);
...
//}
//
//void checkSessionTimeoutBrokenServer(void* /*clientData*/,CommonPlay *cpObj) {
...
//					60/*default*/: sessionTimeoutParameter;
